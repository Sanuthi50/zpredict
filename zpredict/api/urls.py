...
urlpatterns = [
    ...
    path('admin/retry/<int:file_id>/', views.admin_retry_upload, name='admin_retry_upload'),
    path('admin/delete/<int:file_id>/', views.admin_delete_upload, name='admin_delete_upload'),
