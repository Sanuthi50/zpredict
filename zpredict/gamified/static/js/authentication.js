...
async function authenticatedFetch(url, options = {}) {
    ...
    if (!token) {
        console.log('No access token found, redirecting to gamified login');
        window.location.href = 'http://127.0.0.1:8000/gamified/login/';
    ...
    try {
        ...
        if (response.status === 401) {
            ...
            if (refreshSuccess) {
                ...
                // Clear tokens and redirect to gamified login
                clearAuthTokens();
                window.location.href = 'http://127.0.0.1:8000/gamified/login/';
...
function logout() {
    ...
    window.location.href = 'http://127.0.0.1:8000/gamified/';
}
